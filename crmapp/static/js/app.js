...
$(document).ready(function() {
    ...
    $().delegate('.edit-contact', 'click', function(e) {
        e.preventDefault();
        var that = $(this);
        $.get($(this).attr('href'), function(data) {
            $('#new-contact').hide();
    ...
    $().delegate('#contact-form', 'submit', function(e) {
        e.preventDefault();
    ...
    $().delegate('.comm-edit', 'click', function(e) {
        e.preventDefault();
        var that = $(this);
        $.get($(this).attr('href'), function(data) {
